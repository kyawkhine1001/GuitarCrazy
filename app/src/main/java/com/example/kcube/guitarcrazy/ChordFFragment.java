 ...
 */
public class ChordFFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor chordcursor = database_handler.getdata("select * from chords where type='6'");
    ...
    private void fetchData() {
        Call<ResultModel> call = retrofitHelper.getFChord();
