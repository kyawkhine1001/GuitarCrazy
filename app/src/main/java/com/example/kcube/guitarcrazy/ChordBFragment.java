 ...
 */
public class ChordBFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor chordcursor = database_handler.getdata("select * from chords where type='12'");
    ...
    private void fetchData() {
        Call<ResultModel> call = retrofitHelper.getBChord();
