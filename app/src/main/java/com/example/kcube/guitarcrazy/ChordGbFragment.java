 ...
 */
public class ChordGbFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Cursor chordcursor = database_handler.getdata("select * from chords where type='7'");
    ...
    private void fetchData() {
        Call<ResultModel> call = retrofitHelper.getGbChord();
